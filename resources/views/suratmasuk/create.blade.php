...
@section('container')
    ...
    <div>
        <h1><strong>Tambah Surat Masuk</strong></h1>
        <p class="lead">
                ...
                <form action="/surat-masuk" method="POST">
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <input autocomplete="off" type="text" id="datepicker2" class="form-control @error('tanggal_diteruskan') is-invalid @enderror" id="tanggal_diteruskan" name="tanggal_diteruskan" value="{{ old('tanggal_diteruskan') }}">
