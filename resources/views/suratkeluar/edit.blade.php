...
@section('container')
    ...
    <div>
        <h1><strong>Edit Surat Keluar</strong></h1>
        <p class="lead">
            Edit Surat Keluar melalui blanko halaman ini!
        </p>
    </div>
    <div class="mt-3">
        <div class="row">
                ...
                <form action="/surat-keluar/{{ $suratkeluar->id }}" method="POST">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('lampiran') is-invalid @enderror" id="lampiran" name="lampiran" required value="{{ $suratkeluar->lampiran }}">
                            @error('lampiran')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <input autocomplete="off" type="text" id="datepicker" class="form-control @error('tanggal_surat') is-invalid @enderror" id="tanggal_surat" name="tanggal_surat" value="{{ $suratkeluar->tanggal_surat }}">
                            @error('tanggal_surat')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            ...
                            <input autocomplete="off" type="text" class="form-control @error('pengolah') is-invalid @enderror" id="pengolah" name="pengolah" required value="{{ $suratkeluar->pengolah }}">
                            @error('pengolah')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control @error('isi_ringkas') is-invalid @enderror" name="isi_ringkas" id="isi_ringkas" cols="30" rows="3" required>{{ $suratkeluar->isi_ringkas }}</textarea>
                        @error('isi_ringkas')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control @error('catatan') is-invalid @enderror" name="catatan" id="catatan" cols="30" rows="3" required>{{ $suratkeluar->catatan }}</textarea>
                        @error('catatan')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
